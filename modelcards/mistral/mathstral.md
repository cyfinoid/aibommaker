# Model Card: Mathstral

## Model Details

- **Model Name**: Mathstral
- **Provider**: Mistral
...
- Mistral Official Documentation: See provider website

## Citation

See official Mistral documentation for citation information.
