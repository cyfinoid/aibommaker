...
Gemini 1.5 Pro is Google's advanced model with 1M token context window.
...
- **Source**: Verified from official Google documentation
...
- Model-specific documentation: https://ai.google.dev/docs

## Citation

See official Google documentation for citation information.
