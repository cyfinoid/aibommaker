# Model Card: Command R7B Arabic

## Model Details

- **Model Name**: Command R7B Arabic
- **Provider**: Cohere
- **Model Type**: text-generation
- **Model ID**: command-r7b-arabic
...
- Cohere Official Documentation: See provider website

## Citation

See official Cohere documentation for citation information.
