...
GPT-4o is OpenAI's flagship model that reasons across audio, vision, and text in real time.

## Capabilities

Text generation, Vision, Audio

## Model Architecture

- **Context Length**: 128,000 tokens
- **Source**: Verified from official Openai documentation
...
- Model-specific documentation: https://platform.openai.com/docs/models/gpt-4o

## Citation

See official Openai documentation for citation information.
