...
Claude 3.5 Sonnet is Anthropic's most capable model.
...
- **Source**: Verified from official Anthropic documentation
...
- Model-specific documentation: https://docs.anthropic.com/claude/docs/models-overview

## Citation

See official Anthropic documentation for citation information.
